...
import { setNavActive, renderSidebar, closeSidebar } from './shell.js?v=12';
import { viewLanding } from './views/landing.js?v=12';
import { viewAuth } from './views/auth.js?v=12';
import { viewHome } from './views/home.js?v=12';
import { viewTopic } from './views/topic.js?v=12';
import { viewFlash } from './views/flashcards.js?v=12';
import { viewReview } from './views/review.js?v=12';
import { viewQuiz } from './views/quiz.js?v=12';
import { viewSearch } from './views/search.js?v=12';
import { viewSettings } from './views/settings.js?v=12';
import { viewProfile } from './views/profile.js?v=12';
import { viewMatch } from './views/match.js?v=12';
import { viewLeaderboard } from './views/leaderboard.js?v=12';
import { viewAudio } from './views/audio.js?v=12';
import { viewGrammar } from './views/grammar.js?v=12';
import { viewExplore } from './views/explore.js?v=12';
import { viewAI } from './views/ai.js?v=12';
import { viewSpell } from './views/spell.js?v=12';
import { viewInbox } from './views/inbox.js?v=12';
import { viewAdd } from './views/add.js?v=12';
