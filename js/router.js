...
import { setNavActive, renderSidebar, closeSidebar } from './shell.js?v=11';
import { viewLanding } from './views/landing.js?v=11';
import { viewAuth } from './views/auth.js?v=11';
import { viewHome } from './views/home.js?v=11';
import { viewTopic } from './views/topic.js?v=11';
import { viewFlash } from './views/flashcards.js?v=11';
import { viewReview } from './views/review.js?v=11';
import { viewQuiz } from './views/quiz.js?v=11';
import { viewSearch } from './views/search.js?v=11';
import { viewSettings } from './views/settings.js?v=11';
import { viewProfile } from './views/profile.js?v=11';
import { viewMatch } from './views/match.js?v=11';
import { viewLeaderboard } from './views/leaderboard.js?v=11';
import { viewAudio } from './views/audio.js?v=11';
import { viewGrammar } from './views/grammar.js?v=11';
import { viewExplore } from './views/explore.js?v=11';
import { viewAI } from './views/ai.js?v=11';
import { viewSpell } from './views/spell.js?v=11';
import { viewInbox } from './views/inbox.js?v=11';
import { viewAdd } from './views/add.js?v=11';
