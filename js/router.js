...
import { setNavActive, renderSidebar, closeSidebar } from './shell.js?v=13';
import { viewLanding } from './views/landing.js?v=13';
import { viewAuth } from './views/auth.js?v=13';
import { viewHome } from './views/home.js?v=13';
import { viewTopic } from './views/topic.js?v=13';
import { viewFlash } from './views/flashcards.js?v=13';
import { viewReview } from './views/review.js?v=13';
import { viewQuiz } from './views/quiz.js?v=13';
import { viewSearch } from './views/search.js?v=13';
import { viewSettings } from './views/settings.js?v=13';
import { viewProfile } from './views/profile.js?v=13';
import { viewMatch } from './views/match.js?v=13';
import { viewLeaderboard } from './views/leaderboard.js?v=13';
import { viewAudio } from './views/audio.js?v=13';
import { viewGrammar } from './views/grammar.js?v=13';
import { viewExplore } from './views/explore.js?v=13';
import { viewAI } from './views/ai.js?v=13';
import { viewSpell } from './views/spell.js?v=13';
import { viewInbox } from './views/inbox.js?v=13';
import { viewAdd } from './views/add.js?v=13';
