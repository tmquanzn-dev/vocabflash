...
- **Bookmarklet** (không cần cài, mọi trình duyệt kể cả điện thoại): Cài đặt → kéo nút **➕ VocabFlash** lên thanh dấu trang; bôi đen từ trên trang bất kỳ → bấm nút → web mở `#/add?w=…&c=…` với từ + câu chứa từ điền sẵn, AI điền nghĩa, chọn chủ đề → lưu (chạy được cả chế độ khách / local vì lưu thẳng vào dữ liệu đang đăng nhập); bôi đen **cả đoạn** → trang 🌐 Dịch đoạn văn: AI dịch nguyên đoạn + liệt kê từ khó, bấm ＋ (hoặc thêm tất cả) vào chủ đề kèm câu ví dụ lấy từ đoạn
